...
const labels = {
  ...
  ru: {
    ...
    coverKicker: "Маркетинговый план",
    planEmptyTitle: "Маркетингового плана пока нет",
    planEmptyDesc: "Один клик создаёт план раздел за разделом: ключевые слова, конкуренты, спрос и предложение, портреты клиентов — каждый раздел появляется, как только готов.",
    generateFullPlan: "Создать полный план",
    preparingPlan: "Готовим ваш маркетинговый план…",
    preparingPlanHint: "Страница обновится сама, как только будет готов первый раздел — перезагружать не нужно.",
    generatingNow: "Генерация выполняется",
    generatingHint: "Мы всё ещё работаем над этим разделом — он появится автоматически, когда будет готов.",
    stageFailed: "Не удалось сгенерировать",
    retryStage: "Повторить",
    networkError: "Устройство потеряло соединение с интернетом во время операции — это не проблема на нашей стороне. Проверьте подключение и попробуйте снова.",
    funnelOneShot: "На бесплатном пробном пути сообщение создаётся один раз — свяжитесь с нами, чтобы изменить или создать его заново.",
    messageTitle: "Маркетинговое сообщение",
    messageDesc: "Суть плана: ключевое сообщение вашего бренда для аудитории.",
    generateMessage: "Создать маркетинговое сообщение",
    regenerateMessage: "Создать сообщение заново",
    editMessage: "Редактировать сообщение",
    saveMessage: "Сохранить",
    cancelEditMessage: "Отмена",
    messageSaving: "Сохранение...",
    messagePlaceholder: "Напишите здесь ваше маркетинговое сообщение...",
    messageGenerating: "Создаём маркетинговое сообщение...",
    personasGenerating: "Продолжаем создавать портреты клиентов...",
    coverStatsKeywords: "ключевых слов",
    coverStatsCompetitors: "конкурентов",
    coverStatsPersonas: "портретов",
    desc: "Разделён на практические этапы. Каждый этап сохраняется и генерируется независимо.",
    servicesTitle: "Услуги / Товары",
    servicesDesc: "Этот этап выполняется автоматически и обновляет профиль Suite напрямую.",
    addService: "Добавить",
    newService: "Новая услуга или товар",
    newKeyword: "Новое ключевое слово",
    addKeyword: "Добавить ключевое слово",
    moveKeywordUp: "Переместить вверх",
    moveKeywordDown: "Переместить вниз",
    removeKeyword: "Удалить ключевое слово",
    emptyServices: "Услуг пока нет. Добавьте первую, чтобы следующие этапы имели контекст.",
    ...
    personasDesc: "Постройте профили потенциальных клиентов и свяжите их потребности с предложением.",
    pdfTitle: "PDF маркетингового плана",
    downloadPlanPdf: "Скачать PDF маркетингового плана",
    goToWorkPlan: "Перейти к рабочему плану",
    pdfDesc: "Подготовьте PDF для скачивания из всех созданных разделов.",
    showIntro: "Показать описание плана",
    hideIntro: "Скрыть описание плана",
    downloadPdf: "Скачать PDF",
    generate: "Сгенерировать",
    generateMore: "Создать ещё",
    openStage: "Открыть страницу",
    copy: "Копировать",
    copied: "Скопировано",
    preview: "Предпросмотр",
    close: "Закрыть",
    open: "Открыть",
    locked: "Заблокировано до генерации",
    noKeywords: "Ключевые слова ещё не созданы.",
    noCompetitors: "Конкуренты ещё не найдены.",
    noSourceCompetitors: "Нет результатов из этого источника.",
    newCompetitorName: "Название конкурента",
    newCompetitorUrl: "Ссылка на конкурента",
    newCompetitorDescription: "Краткое описание или заметка",
    addCompetitor: "Добавить конкурента",
    cancel: "Отмена",
    moveCompetitorUp: "Переместить вверх",
    moveCompetitorDown: "Переместить вниз",
    sourceOverview: "Показать все источники",
    noDemand: "Спрос и предложение ещё не рассчитаны.",
    noPersonas: "Портреты клиентов ещё не созданы.",
    loadingMorePersonas: "Загружаем больше портретов клиентов...",
    demandAvg: "Средний спрос",
    demandCompetition: "Конкуренция",
    marketPressure: "Давление рынка",
    suggestedKeywords: "Подсказки Google",
    keyword: "Ключевое слово",
    source: "Источник",
    searches: "Запросов в месяц",
    competition: "Конкуренция",
    bidRange: "Диапазон ставок",
    demandSignals: "Спрос",
    supplySignals: "Предложение",
    opportunitySignals: "Возможности",
    collapse: "Свернуть",
    notCompetitor: "Не конкурент",
    goodCompetitor: "Хороший конкурент",
    localCompetitor: "Локальный конкурент",
    globalCompetitor: "Глобальный конкурент",
    nearbyBadge: "Рядом с вами",
    confirmedBadge: "Подтверждённый конкурент",
    leadBadge: "Направление для исследования",
    reviewsWord: "отзывов",
    tagsLabel: "Ваша оценка",
    demandIndicator: "Спрос на рынке",
    competitionIndicator: "Конкуренция",
    byGoogle: "Google",
    bySocial: "Соцсети",
    levelHigh: "Высокий",
    levelMedium: "Средний",
    levelLow: "Низкий",
    levelHighF: "Высокая",
    levelMediumF: "Средняя",
    levelLowF: "Низкая",
    recAllPlatforms: "Лучше присутствовать на всех платформах",
    recFocusSocial: "Лучше сосредоточиться на соцсетях",
    recFocusSearch: "Лучше сосредоточиться на поиске Google",
    recBuildAwareness: "Низкий спрос — сосредоточьтесь на узнаваемости и наращивании аудитории",
    recSeoOpportunity: "Сильная возможность для SEO / GEO",
    recSocialGap: "Слабая конкуренция в соцсетях — возможность стать лидером",
    recDifferentiate: "Высокая конкуренция — выделяйте своё предложение и контент",
    age: "Возраст",
    gender: "Пол",
    profession: "Профессия",
    economicStatus: "Экономический статус",
    challenge: "Проблема",
    need: "Потребность",
    motivation: "Мотивация",
    solution: "Решение предложения",
    pdfNeedsPersonas: "Сначала создайте портреты клиентов, чтобы файл плана был готов к скачиванию.",
  },
  fr: {
    title: "Plan marketing",
    showAll: "Tout afficher",
    collapseAll: "Réduire",
    coverKicker: "Plan marketing",
    planEmptyTitle: "Pas encore de plan marketing",
    planEmptyDesc: "Un clic génère le plan section par section : mots-clés, concurrents, offre et demande, personas clients — chaque section apparaît dès qu'elle est prête.",
    generateFullPlan: "Générer le plan complet",
    preparingPlan: "Préparation de votre plan marketing…",
    preparingPlanHint: "La page se met à jour toute seule dès que la première section est prête — inutile de recharger.",
    generatingNow: "Génération en cours",
    generatingHint: "Nous travaillons encore sur cette section — elle apparaîtra automatiquement une fois prête.",
    stageFailed: "Échec de la génération",
    retryStage: "Réessayer",
    networkError: "Votre appareil a perdu sa connexion Internet pendant l'opération — ce n'est pas un problème de notre côté. Vérifiez votre connexion et réessayez.",
    funnelOneShot: "Dans le parcours d'essai gratuit, le message est généré une seule fois — contactez-nous pour l'ajuster ou le régénérer.",
    messageTitle: "Message marketing",
    messageDesc: "L'essence du plan : le message central que votre marque adresse à son audience.",
    generateMessage: "Générer le message marketing",
    regenerateMessage: "Régénérer le message",
    editMessage: "Modifier le message",
    saveMessage: "Enregistrer",
    cancelEditMessage: "Annuler",
    messageSaving: "Enregistrement...",
    messagePlaceholder: "Écrivez ici votre message marketing...",
    messageGenerating: "Génération du message marketing...",
    personasGenerating: "Génération d'autres personas en cours...",
    coverStatsKeywords: "mots-clés",
    coverStatsCompetitors: "concurrents",
    coverStatsPersonas: "personas",
    desc: "Divisé en étapes pratiques. Chaque étape s'enregistre ou se génère indépendamment.",
    servicesTitle: "Services / Produits",
    servicesDesc: "Cette étape est automatique et met à jour directement le profil du Suite.",
    addService: "Ajouter",
    newService: "Nouveau service ou produit",
    newKeyword: "Nouveau mot-clé",
    addKeyword: "Ajouter un mot-clé",
    moveKeywordUp: "Monter le mot-clé",
    moveKeywordDown: "Descendre le mot-clé",
    removeKeyword: "Supprimer le mot-clé",
    emptyServices: "Aucun service pour l'instant. Ajoutez le premier pour donner du contexte aux étapes suivantes.",
    ...
    personasDesc: "Construisez des profils de clients potentiels et reliez leurs besoins à l'offre marketing.",
    pdfTitle: "PDF du plan marketing",
    downloadPlanPdf: "Télécharger le PDF du plan marketing",
    goToWorkPlan: "Aller au plan de travail",
    pdfDesc: "Préparez un PDF téléchargeable à partir de toutes les sections générées.",
    showIntro: "Afficher l'explication du plan",
    hideIntro: "Masquer l'explication du plan",
    downloadPdf: "Télécharger le PDF",
    generate: "Générer",
    generateMore: "Générer plus",
    openStage: "Ouvrir la page",
    copy: "Copier",
    copied: "Copié",
    preview: "Aperçu",
    close: "Fermer",
    open: "Ouvrir",
    locked: "Verrouillé jusqu'à génération",
    noKeywords: "Aucun mot-clé généré pour l'instant.",
    noCompetitors: "Aucun concurrent généré pour l'instant.",
    noSourceCompetitors: "Aucun résultat pour cette source.",
    newCompetitorName: "Nom du concurrent",
    newCompetitorUrl: "Lien du concurrent",
    newCompetitorDescription: "Brève description ou note",
    addCompetitor: "Ajouter un concurrent",
    cancel: "Annuler",
    moveCompetitorUp: "Monter le concurrent",
    moveCompetitorDown: "Descendre le concurrent",
    sourceOverview: "Voir toutes les sources",
    noDemand: "L'offre et la demande n'ont pas encore été générées.",
    noPersonas: "Aucun persona client généré pour l'instant.",
    loadingMorePersonas: "Chargement d'autres personas clients...",
    demandAvg: "Demande moyenne",
    demandCompetition: "Concurrence",
    marketPressure: "Pression du marché",
    suggestedKeywords: "Suggestions Google",
    keyword: "Mot-clé",
    source: "Source",
    searches: "Recherches mensuelles",
    competition: "Concurrence",
    bidRange: "Fourchette d'enchères",
    demandSignals: "Demande",
    supplySignals: "Offre",
    opportunitySignals: "Opportunités",
    collapse: "Réduire",
    notCompetitor: "Pas un concurrent",
    goodCompetitor: "Bon concurrent",
    localCompetitor: "Concurrent local",
    globalCompetitor: "Concurrent mondial",
    nearbyBadge: "Près de vous",
    confirmedBadge: "Concurrent confirmé",
    leadBadge: "Piste de recherche",
    reviewsWord: "avis",
    tagsLabel: "Votre évaluation",
    demandIndicator: "Demande du marché",
    competitionIndicator: "Concurrence",
    byGoogle: "Google",
    bySocial: "Réseaux sociaux",
    levelHigh: "Élevé",
    levelMedium: "Moyen",
    levelLow: "Faible",
    levelHighF: "Élevée",
    levelMediumF: "Moyenne",
    levelLowF: "Faible",
    recAllPlatforms: "Mieux vaut être présent sur toutes les plateformes",
    recFocusSocial: "Mieux vaut se concentrer sur les réseaux sociaux",
    recFocusSearch: "Mieux vaut se concentrer sur la recherche Google",
    recBuildAwareness: "Faible demande — concentrez-vous sur la notoriété et la construction d'audience",
    recSeoOpportunity: "Forte opportunité SEO / GEO",
    recSocialGap: "Concurrence sociale faible — opportunité de prendre la tête",
    recDifferentiate: "Forte concurrence — différenciez votre offre et votre contenu",
    age: "Âge",
    gender: "Genre",
    profession: "Profession",
    economicStatus: "Statut économique",
    challenge: "Défi",
    need: "Besoin",
    motivation: "Motivation",
    solution: "Solution proposée",
    pdfNeedsPersonas: "Générez d'abord les personas clients pour que le fichier du plan soit prêt à télécharger.",
  },
  es: {
    title: "Plan de marketing",
    showAll: "Mostrar todo",
    collapseAll: "Contraer",
    coverKicker: "Plan de marketing",
    planEmptyTitle: "Aún no hay plan de marketing",
    planEmptyDesc: "Un clic genera el plan sección por sección: palabras clave, competidores, oferta y demanda, y perfiles de clientes — cada sección aparece en cuanto está lista.",
    generateFullPlan: "Generar el plan completo",
    preparingPlan: "Preparando tu plan de marketing…",
    preparingPlanHint: "La página se actualiza sola en cuanto la primera sección está lista — no hace falta recargar.",
    generatingNow: "Generando ahora",
    generatingHint: "Seguimos trabajando en esta sección — aparecerá automáticamente cuando esté lista.",
    stageFailed: "Error al generar",
    retryStage: "Reintentar",
    networkError: "Tu dispositivo perdió la conexión a internet durante la operación — no es un problema de nuestro lado. Revisa tu conexión e inténtalo de nuevo.",
    funnelOneShot: "En la prueba gratuita el mensaje se genera una sola vez — contáctanos para ajustarlo o regenerarlo.",
    messageTitle: "Mensaje de marketing",
    messageDesc: "La esencia del plan: el mensaje central que tu marca comunica a su audiencia.",
    generateMessage: "Generar el mensaje de marketing",
    regenerateMessage: "Regenerar el mensaje",
    editMessage: "Editar mensaje",
    saveMessage: "Guardar",
    cancelEditMessage: "Cancelar",
    messageSaving: "Guardando...",
    messagePlaceholder: "Escribe aquí tu mensaje de marketing...",
    messageGenerating: "Generando el mensaje de marketing...",
    personasGenerating: "Generando más perfiles de clientes...",
    coverStatsKeywords: "palabras clave",
    coverStatsCompetitors: "competidores",
    coverStatsPersonas: "perfiles",
    desc: "Dividido en etapas prácticas. Cada etapa se guarda o genera de forma independiente.",
    servicesTitle: "Servicios / Productos",
    servicesDesc: "Esta etapa es automática y actualiza el perfil del Suite directamente.",
    addService: "Añadir",
    newService: "Nuevo servicio o producto",
    newKeyword: "Nueva palabra clave",
    addKeyword: "Añadir palabra clave",
    moveKeywordUp: "Subir palabra clave",
    moveKeywordDown: "Bajar palabra clave",
    removeKeyword: "Eliminar palabra clave",
    emptyServices: "Aún no hay servicios. Añade el primero para dar contexto a las siguientes etapas.",
    ...
    personasDesc: "Construye perfiles de clientes potenciales y conecta sus necesidades con la oferta de marketing.",
    pdfTitle: "PDF del plan de marketing",
    downloadPlanPdf: "Descargar el PDF del plan de marketing",
    goToWorkPlan: "Ir al plan de trabajo",
    pdfDesc: "Prepara un PDF descargable a partir de todas las secciones generadas.",
    showIntro: "Mostrar explicación del plan",
    hideIntro: "Ocultar explicación del plan",
    downloadPdf: "Descargar PDF",
    generate: "Generar",
    generateMore: "Generar más",
    openStage: "Abrir página",
    copy: "Copiar",
    copied: "Copiado",
    preview: "Vista previa",
    close: "Cerrar",
    open: "Abrir",
    locked: "Bloqueado hasta generarse",
    noKeywords: "Aún no se han generado palabras clave.",
    noCompetitors: "Aún no se han generado competidores.",
    noSourceCompetitors: "No hay resultados de esta fuente.",
    newCompetitorName: "Nombre del competidor",
    newCompetitorUrl: "Enlace del competidor",
    newCompetitorDescription: "Descripción breve o nota",
    addCompetitor: "Añadir competidor",
    cancel: "Cancelar",
    moveCompetitorUp: "Subir competidor",
    moveCompetitorDown: "Bajar competidor",
    sourceOverview: "Ver todas las fuentes",
    noDemand: "Aún no se han generado la oferta y la demanda.",
    noPersonas: "Aún no se han generado perfiles de clientes.",
    loadingMorePersonas: "Cargando más perfiles de clientes...",
    demandAvg: "Demanda media",
    demandCompetition: "Competencia",
    marketPressure: "Presión del mercado",
    suggestedKeywords: "Sugerencias de Google",
    keyword: "Palabra clave",
    source: "Fuente",
    searches: "Búsquedas mensuales",
    competition: "Competencia",
    bidRange: "Rango de puja",
    demandSignals: "Demanda",
    supplySignals: "Oferta",
    opportunitySignals: "Oportunidades",
    collapse: "Contraer",
    notCompetitor: "No es competidor",
    goodCompetitor: "Buen competidor",
    localCompetitor: "Competidor local",
    globalCompetitor: "Competidor global",
    nearbyBadge: "Cerca de ti",
    confirmedBadge: "Competidor confirmado",
    leadBadge: "Pista de investigación",
    reviewsWord: "reseñas",
    tagsLabel: "Tu valoración",
    demandIndicator: "Demanda del mercado",
    competitionIndicator: "Competencia",
    byGoogle: "Google",
    bySocial: "Redes sociales",
    levelHigh: "Alto",
    levelMedium: "Medio",
    levelLow: "Bajo",
    levelHighF: "Alta",
    levelMediumF: "Media",
    levelLowF: "Baja",
    recAllPlatforms: "Mejor estar presente en todas las plataformas",
    recFocusSocial: "Mejor centrarse en las redes sociales",
    recFocusSearch: "Mejor centrarse en la búsqueda de Google",
    recBuildAwareness: "Demanda baja — céntrate en notoriedad y construcción de audiencia",
    recSeoOpportunity: "Fuerte oportunidad de SEO / GEO",
    recSocialGap: "Competencia social débil — oportunidad de liderar",
    recDifferentiate: "Competencia alta — diferencia tu oferta y tu contenido",
    age: "Edad",
    gender: "Género",
    profession: "Profesión",
    economicStatus: "Situación económica",
    challenge: "Reto",
    need: "Necesidad",
    motivation: "Motivación",
    solution: "Solución ofrecida",
    pdfNeedsPersonas: "Genera primero los perfiles de clientes para que el archivo del plan esté listo para descargar.",
  },
  tr: {
    title: "Pazarlama planı",
    showAll: "Tümünü göster",
    collapseAll: "Daralt",
    coverKicker: "Pazarlama planı",
    planEmptyTitle: "Henüz pazarlama planı yok",
    planEmptyDesc: "Tek tıkla plan bölüm bölüm oluşturulur: anahtar kelimeler, rakipler, arz ve talep, müşteri personaları — her bölüm hazır olduğunda görünür.",
    generateFullPlan: "Tam planı oluştur",
    preparingPlan: "Pazarlama planınız hazırlanıyor…",
    preparingPlanHint: "İlk bölüm hazır olduğunda sayfa kendini günceller — yenilemeye gerek yok.",
    generatingNow: "Şu anda oluşturuluyor",
    generatingHint: "Bu bölüm üzerinde hâlâ çalışıyoruz — hazır olduğunda otomatik olarak görünecek.",
    stageFailed: "Oluşturulamadı",
    retryStage: "Tekrar dene",
    networkError: "Cihazınız işlem sırasında internet bağlantısını kaybetti — bu bizim tarafımızdaki bir sorun değil. Bağlantınızı kontrol edip tekrar deneyin.",
    funnelOneShot: "Ücretsiz deneme sürecinde mesaj bir kez oluşturulur — düzenlemek veya yeniden oluşturmak için bizimle iletişime geçin.",
    messageTitle: "Pazarlama mesajı",
    messageDesc: "Planın özü: markanızın hedef kitlesine ilettiği temel mesaj.",
    generateMessage: "Pazarlama mesajını oluştur",
    regenerateMessage: "Mesajı yeniden oluştur",
    editMessage: "Mesajı düzenle",
    saveMessage: "Kaydet",
    cancelEditMessage: "İptal",
    messageSaving: "Kaydediliyor...",
    messagePlaceholder: "Pazarlama mesajınızı buraya yazın...",
    messageGenerating: "Pazarlama mesajı oluşturuluyor...",
    personasGenerating: "Daha fazla persona oluşturuluyor...",
    coverStatsKeywords: "anahtar kelime",
    coverStatsCompetitors: "rakip",
    coverStatsPersonas: "persona",
    desc: "Pratik aşamalara bölünmüştür. Her aşama bağımsız olarak kaydedilir veya oluşturulur.",
    servicesTitle: "Hizmetler / Ürünler",
    servicesDesc: "Bu aşama otomatiktir ve Suite profilini doğrudan günceller.",
    addService: "Ekle",
    newService: "Yeni hizmet veya ürün",
    newKeyword: "Yeni anahtar kelime",
    addKeyword: "Anahtar kelime ekle",
    moveKeywordUp: "Yukarı taşı",
    moveKeywordDown: "Aşağı taşı",
    removeKeyword: "Anahtar kelimeyi kaldır",
    emptyServices: "Henüz hizmet yok. Sonraki aşamaların bağlamı olması için ilkini ekleyin.",
    ...
    personasDesc: "Potansiyel müşteri profilleri oluşturun ve ihtiyaçlarını pazarlama teklifine bağlayın.",
    pdfTitle: "Pazarlama planı PDF'i",
    downloadPlanPdf: "Pazarlama planı PDF'ini indir",
    goToWorkPlan: "Çalışma planına git",
    pdfDesc: "Oluşturulan tüm bölümlerden indirilebilir bir PDF hazırlayın.",
    showIntro: "Plan açıklamasını göster",
    hideIntro: "Plan açıklamasını gizle",
    downloadPdf: "PDF indir",
    generate: "Oluştur",
    generateMore: "Daha fazla oluştur",
    openStage: "Sayfayı aç",
    copy: "Kopyala",
    copied: "Kopyalandı",
    preview: "Önizleme",
    close: "Kapat",
    open: "Aç",
    locked: "Oluşturulana kadar kilitli",
    noKeywords: "Henüz anahtar kelime oluşturulmadı.",
    noCompetitors: "Henüz rakip oluşturulmadı.",
    noSourceCompetitors: "Bu kaynaktan sonuç yok.",
    newCompetitorName: "Rakip adı",
    newCompetitorUrl: "Rakip bağlantısı",
    newCompetitorDescription: "Kısa açıklama veya not",
    addCompetitor: "Rakip ekle",
    cancel: "İptal",
    moveCompetitorUp: "Rakibi yukarı taşı",
    moveCompetitorDown: "Rakibi aşağı taşı",
    sourceOverview: "Tüm kaynakları gör",
    noDemand: "Arz ve talep henüz oluşturulmadı.",
    noPersonas: "Henüz müşteri personası oluşturulmadı.",
    loadingMorePersonas: "Daha fazla müşteri personası yükleniyor...",
    demandAvg: "Ortalama talep",
    demandCompetition: "Rekabet",
    marketPressure: "Pazar baskısı",
    suggestedKeywords: "Google önerileri",
    keyword: "Anahtar kelime",
    source: "Kaynak",
    searches: "Aylık arama",
    competition: "Rekabet",
    bidRange: "Teklif aralığı",
    demandSignals: "Talep",
    supplySignals: "Arz",
    opportunitySignals: "Fırsatlar",
    collapse: "Daralt",
    notCompetitor: "Rakip değil",
    goodCompetitor: "İyi rakip",
    localCompetitor: "Yerel rakip",
    globalCompetitor: "Küresel rakip",
    nearbyBadge: "Yakınınızda",
    confirmedBadge: "Doğrulanmış rakip",
    leadBadge: "Araştırma ipucu",
    reviewsWord: "değerlendirme",
    tagsLabel: "Değerlendirmeniz",
    demandIndicator: "Pazar talebi",
    competitionIndicator: "Rekabet",
    byGoogle: "Google",
    bySocial: "Sosyal",
    levelHigh: "Yüksek",
    levelMedium: "Orta",
    ...
    levelMediumF: "Orta",
    levelLowF: "Düşük",
    recAllPlatforms: "Tüm platformlarda bulunmak daha iyi",
    recFocusSocial: "Sosyal medyaya odaklanmak daha iyi",
    recFocusSearch: "Google aramasına odaklanmak daha iyi",
    recBuildAwareness: "Talep düşük — farkındalık ve kitle oluşturmaya odaklanın",
    recSeoOpportunity: "Güçlü SEO / GEO fırsatı",
    recSocialGap: "Sosyal rekabet zayıf — öne geçme fırsatı",
    recDifferentiate: "Rekabet yüksek — teklifinizi ve içeriğinizi farklılaştırın",
    age: "Yaş",
    gender: "Cinsiyet",
    profession: "Meslek",
    economicStatus: "Ekonomik durum",
    challenge: "Zorluk",
    need: "İhtiyaç",
    motivation: "Motivasyon",
    solution: "Sunulan çözüm",
    pdfNeedsPersonas: "Plan dosyasının indirilmeye hazır olması için önce müşteri personalarını oluşturun.",
  },
  zh: {
    title: "营销计划",
    showAll: "全部展开",
    collapseAll: "收起",
    coverKicker: "营销计划",
    planEmptyTitle: "尚无营销计划",
    planEmptyDesc: "一键即可逐节生成计划：关键词、竞争对手、供需分析和客户画像——每个板块准备好后即刻显示。",
    generateFullPlan: "生成完整计划",
    preparingPlan: "正在准备您的营销计划…",
    preparingPlanHint: "第一个板块就绪后页面会自动更新，无需刷新。",
    generatingNow: "正在生成",
    generatingHint: "我们仍在处理该板块——完成后会自动显示。",
    stageFailed: "生成失败",
    retryStage: "重试",
    networkError: "您的设备在操作过程中断开了网络连接——这不是我们这边的问题。请检查网络后重试。",
    funnelOneShot: "在免费试用流程中，信息只生成一次——如需调整或重新生成请联系我们。",
    messageTitle: "营销信息",
    messageDesc: "计划的核心：您的品牌向受众传达的核心信息。",
    generateMessage: "生成营销信息",
    regenerateMessage: "重新生成信息",
    editMessage: "编辑信息",
    saveMessage: "保存",
    cancelEditMessage: "取消",
    messageSaving: "保存中...",
    messagePlaceholder: "在此撰写您的营销信息...",
    messageGenerating: "正在生成营销信息...",
    personasGenerating: "正在生成更多客户画像...",
    coverStatsKeywords: "个关键词",
    coverStatsCompetitors: "个竞争对手",
    coverStatsPersonas: "个客户画像",
    desc: "拆分为可执行的阶段，每个阶段独立保存或生成。",
    servicesTitle: "服务 / 产品",
    servicesDesc: "此阶段为自动执行，并直接更新 Suite 档案。",
    addService: "添加",
    newService: "新的服务或产品",
    newKeyword: "新关键词",
    addKeyword: "添加关键词",
    moveKeywordUp: "上移关键词",
    moveKeywordDown: "下移关键词",
    removeKeyword: "删除关键词",
    emptyServices: "尚无服务。请添加第一个，以便后续阶段有上下文。",
    keywordsTitle: "关键词",
    ...
    personasDesc: "构建潜在客户档案，并将其需求与营销提案相连接。",
    pdfTitle: "营销计划 PDF",
    downloadPlanPdf: "下载营销计划 PDF",
    goToWorkPlan: "前往工作计划",
    pdfDesc: "用所有已生成的板块准备可下载的 PDF。",
    showIntro: "显示计划说明",
    hideIntro: "隐藏计划说明",
    downloadPdf: "下载 PDF",
    generate: "生成",
    ...
    locked: "生成后解锁",
    noKeywords: "尚未生成关键词。",
    noCompetitors: "尚未生成竞争对手。",
    noSourceCompetitors: "该来源没有结果。",
    newCompetitorName: "竞争对手名称",
    newCompetitorUrl: "竞争对手链接",
    newCompetitorDescription: "简短描述或备注",
    addCompetitor: "添加竞争对手",
    cancel: "取消",
    moveCompetitorUp: "上移竞争对手",
    moveCompetitorDown: "下移竞争对手",
    sourceOverview: "查看所有来源",
    noDemand: "尚未生成供需分析。",
    noPersonas: "尚未生成客户画像。",
    loadingMorePersonas: "正在加载更多客户画像...",
    demandAvg: "平均需求",
    demandCompetition: "竞争",
    marketPressure: "市场压力",
    suggestedKeywords: "Google 建议",
    keyword: "关键词",
    source: "来源",
    searches: "月搜索量",
    competition: "竞争",
    ...
    demandSignals: "需求",
    supplySignals: "供给",
    opportunitySignals: "机会",
    collapse: "收起",
    notCompetitor: "非竞争对手",
    goodCompetitor: "优质竞争对手",
    localCompetitor: "本地竞争对手",
    globalCompetitor: "全球竞争对手",
    nearbyBadge: "在您附近",
    confirmedBadge: "已确认的竞争对手",
    leadBadge: "研究线索",
    reviewsWord: "条评价",
    tagsLabel: "您的评价",
    demandIndicator: "市场需求",
    competitionIndicator: "竞争",
    byGoogle: "Google",
    bySocial: "社交",
    levelHigh: "高",
    levelMedium: "中",
    ...
    levelMediumF: "中",
    levelLowF: "低",
    recAllPlatforms: "建议在所有平台保持存在",
    recFocusSocial: "建议专注于社交媒体",
    recFocusSearch: "建议专注于 Google 搜索",
    recBuildAwareness: "需求较低——专注于提升认知度和积累受众",
    recSeoOpportunity: "强劲的 SEO / GEO 机会",
    recSocialGap: "社交竞争薄弱——抢占领先的机会",
    recDifferentiate: "竞争激烈——让您的提案和内容与众不同",
    age: "年龄",
    gender: "性别",
    profession: "职业",
    economicStatus: "经济状况",
    ...
    motivation: "动机",
    solution: "提案解决方案",
    pdfNeedsPersonas: "请先生成客户画像，以便计划文件可供下载。",
  },
};
