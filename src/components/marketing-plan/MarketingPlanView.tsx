...
const copy = {
  ...
  ru: {
    insight: "Аналитика OneShare",
    fallbackInsight: "Маркетинговое направление на основе профиля бизнеса.",
    marketingPlan: "Маркетинговый план",
    sections: "Разделы",
    focus: "Фокус",
    generated: "Сгенерировано",
    researchBase: "База исследования",
    researchDescription: "План фиксирует, что было использовано и что ещё требует проверки.",
    monthlyTitle: "Месячный план для соцсетей",
    monthlyDescription: "План органического контента: 70% привлечение, 20% доверие, 10% продажи.",
    cadence: "Рекомендуемая частота",
    weeklyPosts: "постов/неделю",
    monthlyPosts: "идей/месяц",
    questions: "Вопросы перед запуском месяца",
    calendar: "Календарь и культурные проверки",
    generate: "Сгенерировать",
    needsAsset: "Нужны видео или загруженный файл от клиента.",
    funnelTitle: "Платная маркетинговая воронка",
    funnelDescription: "От узнаваемости до амбассадоров, с идеями, которые станут материалами кампаний.",
  },
  fr: {
    insight: "Analyse OneShare",
    fallbackInsight: "Orientation marketing construite à partir du profil de l'entreprise.",
    marketingPlan: "Plan marketing",
    sections: "Sections",
    focus: "Priorité",
    generated: "Généré",
    researchBase: "Base de recherche",
    researchDescription: "Le plan documente ce qui a été utilisé et ce qui reste à valider.",
    monthlyTitle: "Plan mensuel pour les réseaux sociaux",
    monthlyDescription: "Plan de contenu organique : 70% attraction, 20% confiance, 10% ventes.",
    cadence: "Cadence recommandée",
    weeklyPosts: "publications/semaine",
    monthlyPosts: "idées/mois",
    questions: "Questions avant d'appliquer le mois",
    calendar: "Calendrier et vérifications culturelles",
    generate: "Générer",
    needsAsset: "Nécessite une vidéo du client ou un fichier importé.",
    funnelTitle: "Tunnel marketing payant",
    funnelDescription: "De la notoriété à l'ambassadeur, avec des idées transformables en matériels de campagne.",
  },
  es: {
    insight: "Análisis de OneShare",
    fallbackInsight: "Dirección de marketing basada en el perfil del negocio.",
    marketingPlan: "Plan de marketing",
    sections: "Secciones",
    focus: "Enfoque",
    generated: "Generado",
    researchBase: "Base de investigación",
    researchDescription: "El plan documenta lo que se usó y lo que aún necesita validación.",
    monthlyTitle: "Plan mensual para redes sociales",
    monthlyDescription: "Plan de contenido orgánico: 70% atracción, 20% confianza y 10% ventas.",
    cadence: "Frecuencia recomendada",
    weeklyPosts: "publicaciones/semana",
    monthlyPosts: "ideas/mes",
    questions: "Preguntas antes de aplicar el mes",
    calendar: "Calendario y comprobaciones culturales",
    generate: "Generar",
    needsAsset: "Necesita vídeo del cliente o un archivo subido.",
    funnelTitle: "Embudo de marketing de pago",
    funnelDescription: "De la notoriedad al embajador, con ideas que pueden convertirse en materiales de campaña.",
  },
  tr: {
    insight: "OneShare içgörüsü",
    fallbackInsight: "İşletme profilinden oluşturulan pazarlama yönü.",
    marketingPlan: "Pazarlama planı",
    sections: "Bölümler",
    focus: "Odak",
    generated: "Oluşturuldu",
    researchBase: "Araştırma temeli",
    researchDescription: "Plan, nelerin kullanıldığını ve nelerin hâlâ doğrulanması gerektiğini belgeler.",
    monthlyTitle: "Aylık sosyal medya çalışma planı",
    monthlyDescription: "Organik içerik planı: %70 ilgi çekme, %20 güven, %10 satış.",
    cadence: "Önerilen paylaşım sıklığı",
    weeklyPosts: "gönderi/hafta",
    monthlyPosts: "fikir/ay",
    questions: "Ayı uygulamadan önceki sorular",
    calendar: "Takvim ve kültürel kontroller",
    generate: "Oluştur",
    needsAsset: "Müşteri videosu veya yüklenmiş dosya gerekir.",
    funnelTitle: "Ücretli pazarlama hunisi",
    funnelDescription: "Farkındalıktan elçiliğe, kampanya materyaline dönüşebilecek yaratıcı fikirlerle.",
  },
  zh: {
    insight: "OneShare 洞察",
    fallbackInsight: "根据企业档案制定的营销方向。",
    marketingPlan: "营销计划",
    sections: "板块",
    focus: "重点",
    generated: "已生成",
    researchBase: "研究依据",
    researchDescription: "本计划记录了已采用的内容以及仍需验证的部分。",
    monthlyTitle: "每月社交媒体工作计划",
    monthlyDescription: "自然内容计划：70% 吸引、20% 信任、10% 销售。",
    cadence: "建议发布频率",
    weeklyPosts: "帖/周",
    monthlyPosts: "创意/月",
    questions: "执行本月计划前的问题",
    calendar: "日历与文化检查",
    generate: "生成",
    needsAsset: "需要客户提供的视频或已上传的素材。",
    funnelTitle: "付费营销漏斗",
    funnelDescription: "从认知到品牌大使，创意可转化为生成素材或活动物料。",
  },
};
